...
export default {
  ...
  plugins: [
    // Generate an external CSS file whith a hash in the filename
    ...
    // vendor libraries so that they're chaed separately.
    ...
    // Eliminate duplicte packages when generating bundle
